    ...
    <aside id="sidebar" class="side">
      <div class="h-100">
        ...
        <ul class="sidebar_nav" style="max-height: 80vh; overflow-y: auto;">
            ...
            <!-- <li class="sidebar_item">
              <a href="../visitor_profil.php" class="sidebar_link"> <img src="../../.././public/assets/images/agents.svg" alt="">profil</a>
            </li>
            
            <li class="sidebar_item">
              <a href="freelancers.php" class="sidebar_link"> <img src="../../.././public/assets/images/agents.svg" alt="">freelancer</a>
            </li>

            <li class="sidebar_item">
              <a href="../profil.php" class="sidebar_link"> <img src="../../.././public/assets/images/agents.svg" alt="">profil</a>
            </li>
            
            <li class="sidebar_item">
              <a href="testimonials.php" class="sidebar_link"> <img src="../../.././public/assets/images/agents.svg" alt="#">Testimonial</a>
            </li>
            ...
            <li class="sidebar_item ">
              <a href="categories.php" class="sidebar_link"><img src="../../.././public/assets/images/agent.svg" alt="">Categories</a>
            </li>
         
            <li class="sidebar_item">
              <a href="sub-categories.php" class="sidebar_link"><img src="../../.././public/assets/images/articles.svg" alt="">Sub-categories</a>
            </li>
           
            <li class="sidebar_item ">
              <a href="projects.php" class="sidebar_link"><img src="../../.././public/assets/images/articles.svg" alt="">projects</a>
            </li>
            ...
            <li class="sidebar_item ">
              <a href="offers.php" class="sidebar_link"><img src="../../.././public/assets/images/articles.svg" alt="">Offers</a>
            </li> -->
            
            <!-- <li class="sidebar_item ">
              <a href="myoffers.php" class="sidebar_link"><img src="../../.././public/assets/images/articles.svg" alt="">My Offers</a>
            </li>
             -->
          <li class="sidebar_item">
